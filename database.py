...
class DataBase:
    ...
    def connect(self):
        mongod = pymongo.MongoClient(
            "mongodb+srv://cool:susuboneto123@cluster0.44volcv.mongodb.net/?retryWrites=true&w=majority")
    ...
    def insert(self, user_id, name, username, age, domisili):
        # time-stamp
